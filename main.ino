...
//DEVICE NAME
String  did = "DOT_AMP_002";//might change so didn't define as const char*
...
//OUT TOPIC
const char* mrtimeTopic = "autobots/dot/amp";
const char* rpmTopic = "autobots/dot/rpm";
const char* responseTopic = "autobots/dot/response";
//IN TOPIC
const char* configTopic = "autobots/dot/config";
const char* cmdTopic = "autobots/dot/cmd";
...
void checkIrmsPublishTimer() {
  ...
  unsigned long now = millis();
  if ((now - lastPublishedTime > publish_interval) && FLAG == HIGH) {
